...
const buttonClass = computed(() => {
  const baseClass =
    'size-9 md:size-6 flex items-center justify-center rounded-lg transition-all duration-200 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1';
